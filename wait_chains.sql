...
SELECT *
FROM (SELECT 'Current Process: '||osid W_PROC, 'SID '||s.sid||'_'||s.serial# as session_n,
 ...
 'SQL id:'||nvl2(s.sql_id,s.sql_id,s.PREV_SQL_ID)||' Text:'||SQL.SQL_TEXT LAst_SQL,
...
WHERE wc.instance = i.instance_number (+)
 ...
 and nvl2(s.sql_id,s.sql_id,s.PREV_SQL_ID)=sql.sql_id(+)
 AND ( num_waiters > 0
