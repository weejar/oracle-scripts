 ...
 *
 * Modifications:
 *	TGorman	29sep08	adapted from the earlier STATSPACK-based "sphistory.sql" script
 *  Weejar Zhang(anbob.com) 2015/05/01 add instance number indentify
 *
 * Call:
...
col rows_per_exec format 999,999,999,990.00 heading "Avg Rows|Per Exec"
...
ttitle center 'Summary Execution Statistics Over Time of SQL_ID:&&V_SQL_ID'
